...
export default function ExploreHero({ total, loading }: ExploreHeroProps) {
    ...
    return (
        <section className="relative overflow-hidden border-b border-[#0d2818] bg-[#0a0a0a] flex items-center justify-center h-screen ">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[320px] rounded-full pointer-events-none"
                style={{ background: "radial-gradient(ellipse at center, rgba(16,185,129,0.18) 0%, rgba(16,185,129,0.06) 45%, transparent 70%)" }}
            />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[260px] h-[160px] rounded-full pointer-events-none"
                style={{ background: "radial-gradient(ellipse at center, rgba(52,211,153,0.13) 0%, transparent 70%)" }}
            />
            ...
            <div className="inline-flex items-center gap-8 bg-white/[0.03] border border-emerald-500/[0.12] rounded-2xl px-9 py-4">
                <div className="text-center">
                    <div className="text-[28px] font-semibold text-white font-mono tracking-tight">
                        {loading ? "—" : total.toLocaleString()}
                    </div>
                    <div className="text-[11px] text-emerald-400/60 mt-1">Snippet Publik</div>
                </div>
                <div className="w-px h-9 bg-emerald-500/15" />
                <div className="text-center">
                    <div className="text-[28px] font-semibold text-white font-mono tracking-tight">1.2K</div>
                    <div className="text-[11px] text-emerald-400/60 mt-1">Developer Aktif</div>
                </div>
                <div className="w-px h-9 bg-emerald-500/15" />
                <div className="text-center">
                    <div className="text-[28px] font-semibold text-white font-mono tracking-tight">48</div>
                    <div className="text-[11px] text-emerald-400/60 mt-1">Bahasa</div>
                </div>
            </div>
        </div>
        </section >
